          ...
          <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            <article className="rounded-[20px] border border-[#4e3a95]/20 bg-white/70 p-4 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
              <div className="relative overflow-hidden rounded-2xl border border-[#4e3a95]/20">
                <Image
                  src="/à_propos-pict/laurentIlonga.JPG"
              ...
              <p className="mt-1 text-sm font-semibold text-[#3f2f86]">Président (CEO) busnessman</p>
               <p className="mt-1 text-sm font-semibold text-[#3f2f86]">30 / 06 / 2000.</p>
            </article>

            <article className="rounded-[20px] border border-[#4e3a95]/20 bg-white/70 p-4 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
              <div className="relative overflow-hidden rounded-2xl border border-[#4e3a95]/20">
                <Image
                  src="/à_propos-pict/Despi.jpeg"
                  alt="Desmond Despi"
                  width={900}
                  height={900}
                  className="h-72 w-full object-cover"
              ...
              <p className="mt-1 text-sm font-semibold text-[#3f2f86]">(Superviseur / Résposable de suivis) Manager d'artistes</p>
               <p className="mt-1 text-sm font-semibold text-[#3f2f86]">16 / 12 / 2000</p>
            ...
            <article className="rounded-[20px] border border-[#4e3a95]/20 bg-white/70 p-4 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
              ...
              <p className="mt-1 text-sm font-semibold text-[#3f2f86]">Secrétaire / et manager d'artistes</p>
               <p className="mt-1 text-sm font-semibold text-[#3f2f86]">16 / 08 / 2002</p>
            </article>

            <article className="rounded-[20px] border border-[#4e3a95]/20 bg-white/70 p-4 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
              <div className="relative overflow-hidden rounded-2xl border border-[#4e3a95]/20">
                <Image
                  src="/à_propos-pict/HK.jpg"
                  alt="Henock HK"
                  width={900}
                  height={900}
                  className="h-72 w-full object-cover"
              ...
              <p className="mt-1 text-sm font-semibold text-[#3f2f86]">Direction de comptable / Habilleur</p>
               <p className="mt-1 text-sm font-semibold text-[#3f2f86]">10 / 03 / 2003</p>
            </article>
            ...
            <article className="rounded-[20px] border border-[#4e3a95]/20 bg-white/70 p-4 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
              ...
              <p className="mt-1 text-sm font-semibold text-[#3f2f86]">Direction artistique /Artiste visuel styliste</p>
                <p className="mt-1 text-sm font-semibold text-[#3f2f86]">20 / 02 / 1998</p>
            </article>

            <article className="rounded-[20px] border border-[#4e3a95]/20 bg-white/70 p-4 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
              <div className="relative overflow-hidden rounded-2xl border border-[#4e3a95]/20">
                <Image
                  src="/à_propos-pict/leprince.jpeg"
                  alt="Le Prince"
                  width={900}
                  height={900}
                  className="h-72 w-full object-cover"
              ...
              <p className="mt-1 text-sm font-semibold text-[#3f2f86]">Direction technique développeur web et mobile & IA.</p>
               <p className="mt-1 text-sm font-semibold text-[#3f2f86]">13 decembre 2002</p>
            ...
            <article className="rounded-[20px] border border-[#4e3a95]/20 bg-white/70 p-4 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
              ...
              <p className="mt-1 text-sm font-semibold text-[#3f2f86]">Chef de media / Admin et partenaire</p>
              <p className="mt-1 text-sm font-semibold text-[#3f2f86]">01 / 01 /2000</p>
            </article>
