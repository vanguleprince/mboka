    ...
    <main className="relative min-h-screen overflow-hidden bg-[#09080f] px-4 py-10 text-white sm:px-8">
      ...
      <div className="relative mx-auto w-full max-w-5xl">
        ...
        <section className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-4">
          {/* Spotify Link */}
          <a
            href="https://open.spotify.com/artist/14CMqCyT5GDbEJpzn8EmsJ?si=7dx-i4_wSl2dmBzYbjAIcg"
            target="_blank"
          ...
          {/* Instagram Link */}
          <a
            href="https://www.instagram.com/bigflackocram?igsh=MXd5Z3Ztamh6MjQyMA=="
            target="_blank"
            rel="noopener noreferrer"
          ...
          {/* TikTok Link */}
          <a
            href="https://www.tiktok.com/@bigflackocram?_r=1&_t=ZS-96T2YFockBZ"
            target="_blank"
            rel="noopener noreferrer"
