...
const newsItems = [
  {
    ...
    detail: "Keurma peaufine un nouveau single afro pop avec une direction vocale plus organique.",
  },
  {
...
const merchItems = [
  {
    name: "T-shirt Keurma Wave",
    description: "Coupe streetwear inspiree de l'identite visuelle de Keurma.",
    price: "25$",
  },
  {
    name: "Hoodie Sunset",
          ...
          <div className="rounded-[32px] border border-white/10 bg-black/40 p-5 backdrop-blur-xl sm:p-7">
            <div className="mb-5 flex items-center justify-between gap-3">
              <div>
                ...
                <h2 className="mt-2 text-lg font-bold text-white">Les news de Keurma</h2>
              </div>
              <span className="rounded-full border border-violet-300/30 bg-violet-300/10 px-3 py-1 text-xs tracking-[0.14em] text-violet-200">
                UPDATE
              </span>
          ...
          <div className="rounded-[32px] border border-violet-300/20 bg-[linear-gradient(180deg,rgba(109,40,217,0.18),rgba(9,8,15,0.82))] p-5 backdrop-blur-xl sm:p-7">
            <div className="mb-5">
              ...
              <p className="mt-2 text-sm leading-6 text-zinc-300">
                Une selection de pieces inspirees de l&apos;univers visuel de Keurma.
              </p>
            </div>
