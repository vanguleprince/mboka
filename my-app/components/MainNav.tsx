        ...
        <div className="fixed inset-0 z-120 md:hidden" role="presentation">
          ...
          <div className="absolute right-4 top-28 w-[min(26rem,calc(100vw-2rem))] overflow-hidden rounded-4xl border border-white/20 bg-[linear-gradient(135deg,rgba(139,92,246,0.44),rgba(59,130,246,0.34)),linear-gradient(180deg,rgba(10,12,24,0.88),rgba(10,12,24,0.76))] p-4 shadow-[0_30px_90px_rgba(2,6,23,0.78)] backdrop-blur-3xl ring-1 ring-white/16 sm:right-6 sm:top-30">
            ...
            <div className="relative">
              <div className="mb-4 flex items-center justify-between rounded-2xl border border-white/15 bg-black/35 px-4 py-3">
                <div>
              ...
              {navLinks.map((item) => (
                <Link
                  ...
                  href={item.href}
                  onClick={() => setIsOpen(false)}
                  className="group relative overflow-hidden rounded-2xl border border-violet-400/30 bg-[linear-gradient(135deg,rgba(109,40,217,0.72),rgba(37,99,235,0.58))] px-5 py-4 text-center text-sm font-bold text-white shadow-[0_4px_24px_rgba(109,40,217,0.28),inset_0_1px_0_rgba(255,255,255,0.22)] transition-all hover:brightness-110 hover:shadow-[0_6px_30px_rgba(109,40,217,0.42)]"
                >
